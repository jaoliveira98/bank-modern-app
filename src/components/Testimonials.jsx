  ...
  return (
    ...
    >
      <div
        ...
        role="img"
        aria-label="Background gradient image"
      />

      <div
        className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]"
        aria-label="Testimonials section content"
      >
        <h2 className={styles.heading2}>
          What People are saying about us<span aria-hidden="true">&nbsp;</span>
          <br className="sm:hidden" />
          <span className="sr-only">and our services</span>
        </h2>
